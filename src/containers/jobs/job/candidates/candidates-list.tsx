...
const Candidates = () => {
  ...
  return (
    <TableContainer width='100%' maxHeight='97%' overflowY='auto' bg='brand.white' border='2px solid' borderColor='brand.grey200' borderRadius='4px'>
      <Table variant='unstyled'>
        <Thead position='sticky' top='0' bg='brand.grey100' zIndex='1000'>
          <TableRow>
